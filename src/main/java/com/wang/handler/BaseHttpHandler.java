...
public abstract class BaseHttpHandler implements HttpHandler {
    ...
    private void handlePost(HttpExchange httpExchange) throws Exception{
        ...
        String IPPort = doHandlePost(parameters);
        //responseCode 是状态码
        int responseCode = 200;
        handleResponse(httpExchange, IPPort, responseCode);
    }
    ...
    abstract protected String doHandlePost(Map<String, String> parameters) throws Exception;
